...
//  this function copies the generated password to user clipboard
  ...
  return (
    ...
    {/* copy button  */}
         ...
         className='outline-none hover:bg-blue-600
           bg-blue-700 text-white px-3 py-0.5 shrink-0'>Copy</button>
